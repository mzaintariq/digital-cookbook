  ...
  <div class="flex gap-2 h-8">
    ...
    <div v-else class="flex gap-2">
      <input v-model="localValue" type="text" :placeholder="placeholder" @keyup.enter="handleAdd"
        ...
        class="px-2 py-1.5 text-sm border border-paper-400 dark:border-paper-700 dark:bg-paper-950 rounded focus:outline-none focus:ring-1 focus:ring-brand-primary"
        autofocus />
