<template>
  <div class="flex items-center justify-between mb-3 pb-2 border-b border-gray-200 h-8">
    <div class="flex items-center gap-2 flex-1">
      ...
      <button type="button" v-if="!isEditing" @click="$emit('edit')" class="text-xs text-gray-500 hover:text-gray-700">
    ...
    <div class="flex items-center gap-2">
      <button type="button" @click="$emit('delete')" class="text-red-500 hover:text-red-700">
