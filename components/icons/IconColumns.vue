<template>
    <svg :class="iconClass" :width="size" :height="size" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        <path fill-opacity=".5" d="M2 5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5Z" />
